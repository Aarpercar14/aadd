...
public class PruebaEntrega1 {
	...
	public static void main(String[] args) throws RepositorioException, EntidadNoEncontrada, SAXException,
			ParserConfigurationException, SitioTuristicoException {
		...
		try {
			admin.EstablecerSitioTuristico(idEstacion,
					(LinkedList<ResumenSitioTuristico>) admin.getSitiosTuristicos(idEstacion));
		...
		System.out.println("\nLista de resúmenes de sitios turisticos extraida usando el api geoNames { \n");
